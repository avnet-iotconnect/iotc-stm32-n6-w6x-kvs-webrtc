...
/**
 * @brief  Start the sensor only (ISP_Init + ISP_Start + MODE_STREAMING).
 *         Use when the DCMIPP pipe is being driven via HAL directly (e.g.
 *         semi-planar DBM) and only the middleware's ISP/sensor portion of
