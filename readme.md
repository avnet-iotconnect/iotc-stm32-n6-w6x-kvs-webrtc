...
2. Update ST67W611M module firmware and middleware to the **latest version** (V1.3.0+):
   - Flash the latest T02 mission profile using `NCP_update_mission_profile_t02` from [x-cube-st67w61](https://github.com/STMicroelectronics/x-cube-st67w61/tree/main/Projects/ST67W6X_Scripts/Binaries)
   - **Critical:** Older module firmware / middleware versions have a WAN UDP receive bug that prevents WebRTC ICE negotiation from completing
...
- [STM32CubeProgrammer](https://www.st.com/en/development-tools/stm32cubeprog.html) `2.20.x` (flashing)
- [STM32CubeIDE](https://www.st.com/en/development-tools/stm32cubeide.html) (build/debug from source)
- [X-CUBE-ST67W61](https://github.com/STMicroelectronics/x-cube-st67w61) **V1.3.0+** (Wi-Fi middleware and module firmware)

STM32CubeProgrammer `2.21.0+` changed STM32N6 signing behavior; see [docs/troubleshooting.md](docs/troubleshooting.md).

> **Important:** The ST67W611M module firmware and X-CUBE-ST67W61 middleware must be V1.3.0 or later. Earlier versions have a WAN UDP receive bug that breaks WebRTC TURN relay negotiation.
